...
from .ssd_matcher import Matcher, SSDMatcher
...
class SSD(nn.Module):
    ...
    def postprocess_detections(
        ...
        for boxes, scores, anchors, image_shape in zip(bbox_regression, pred_scores, image_anchors, image_shapes):
            ...
            boxes = ops.clip_boxes_to_image(boxes, image_shape)
            ...
            keep = ops.batched_nms(image_boxes, image_scores, image_labels, self.nms_thresh)
